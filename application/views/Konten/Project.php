...
<div class="tabbable">
	<ul class="nav nav-tabs" id="myTab">
		<li class="active">
			<a data-toggle="tab" href="#kamus" id="<?php echo base_url().'Yasiwa/project/Current_Project';?>" style="color:green;">
				Current Project
			</a>
		</li>

		<li>
			<a data-toggle="tab" href="#profile" id="<?php echo base_url().'Yasiwa/project/Previous_Project';?>" style="color:green;">
				Previous Project
			</a>
		</li>
	</ul>
   ...
   $(document).ready(function(){
    ...
    $('.tab-content').on('click','ul#cari>li>a',function(e){
     ...
     $.ajax({
      ...
      success:function(response){
       var $page_data = $(response);
       $('.tab-content').html($page_data.find('#profile'));
      }
     });
    });
   });
    ...
    <?php foreach($data as $row ){?>
                    	<li>
                    			...
                    			<h6>Published : <?php echo $row->tglPub;?> Author : Yasiwa Project Type: <?php echo $row->prj_type;?></h6>
                    			<br>
