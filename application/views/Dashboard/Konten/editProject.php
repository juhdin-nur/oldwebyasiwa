                                                    ...
                                                    <form class="form-horizontal" id="validation-form"> 
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-9">
                                                                <div class="clearfix">
                                                                    <input type="hidden" name="id" id="id" value="<?php echo $hasil->id;?>" class="col-xs-12 col-sm-6">
                                                                    <input type="text" name="lokasi" id="lokasi" value="<?php echo $hasil->loc;?>" class="col-xs-12 col-sm-6">
                                                                </div>
                                                            </div>
                                                        </div>                                                            
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <?php $date=new DateTime($hasil->tglPub);$tgl=$date->format('d/m/Y H:i');?>
                                                            <div class="col-xs-12 col-sm-9">
                                                                <div class="clearfix">
                                                                    <input type="text" name="tglPub" id="tglPub" value="<?php echo $tgl;?>" class="col-xs-12 col-sm-6" data-date="2012-12-21T15:25:00Z">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-9">
                                                                <?php if($hasil->prj_type=='Current_Project'){?>
                                                                <div>
                                                                    <label class="line-height-1 blue">
                                                                        <input name="prj_type" value="1" type="radio" class="ace" checked="true">
                                                            ...
                                                            <?php }else if($hasil->prj_type=='Previous_Project'){?>
                                                                <div>
                                                                    <label class="line-height-1 blue">
                                                                        <input name="prj_type" value="1" type="radio" class="ace" checked="true">
                                                                        <span class="lbl">Project Sedang Berjalan</span>
                                                                ...
                                                                <div>
                                                                    <label class="line-height-1 blue">
                                                                        <input name="prj_type" value="2" type="radio" class="ace" checked="true">
                                                                        <span class="lbl"> Project Sebelumnya</span>
                                                                    </label>
                                                                </div> 
                                                            <?php }else{?>
                                                            ...
                                                            <div class="tabbable">
                                                                ...
                                                                <div class="tab-content">
                                                                    <div id="home" class="tab-pane fade active in">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-xs-12 col-sm-9">
                                                                                <div class="clearfix">
                                                                                    <input type="text" name="judul" value="<?php echo $hasil->judul; ?>" id="judul" class="col-xs-12 col-sm-6">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                          ...
                                                                          <div class="col-xs-12 col-sm-9">                    
                                                                            <textarea class="form-control" id="txtbahasa" name="isi" style="width:auto;"><?php echo $hasil->isi; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div id="messages" class="tab-pane fade">
                                                                    ...
                                                                    <div class="form-group">
                                                                      ...
                                                                      <div class="col-xs-12 col-sm-9">                    
                                                                        <textarea class="mceEditor" id="txtenglish" name="konten" style="width:auto;"><?php echo $hasil->konten;?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<!-- <script type="text/javascript" src="<?php echo base_url();?>Design/tinymce/js/tinymce/jquery.tinymce.min.js"></script> -->
...
<script type="text/javascript">
    ...
    soundPath: '../sounds/'
     ...
     $('#tglPub').datetimepicker({format: "DD/MM/YYYY HH:mm",
        showMeridian: true,
        autoclose: true,
        todayBtn: true}).next().on(ace.click_event, function(){
                        $(this).prev().focus();
    ...
    //             });
        ...
        $.ajax({
            ...
            success: function(data)
            {
                        ...
                        window.location='<?php echo base_url();?>dashboard/project';
                    },
