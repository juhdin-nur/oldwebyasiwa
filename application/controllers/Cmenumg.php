...
class Cmenumg extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('mediaOpt','mmedia');
    ...
    public function ajax_list2()
    {
        ...
        foreach ($list as $routemodel) {
            $no++;
            $row = array();
            $row[]=$routemodel->title_cat;
            $row[]=$routemodel->description_cat;            
            $row[]=$routemodel->createTime_cat;     
            $row[]=$routemodel->modifiedTime_cat;     
            //add html for action
    ...
    public function add_cat()
    {
        ...
        $data = array('title_cat' =>$this->input->post('title'), 
                      'description_cat' => $this->input->post('description'),
                      'createTime_cat'=> date('Y-m-d H:i:s')
                    );
    ...
    public function ajax_update2()
    {
        ...
        date_default_timezone_set('Asia/Makassar');
        $data = array(
                'title_cat' => $this->input->post('title'),
                'description_cat' => $this->input->post('description'),
                'modifiedTime_cat' => date('Y-m-d H:i:s'),
    ...
    public function ajax_delete2($id)
    {
        ...
        $this->mmedia->delete_by_idForegn($id);
        echo json_encode(array("status" => TRUE));
    }
}
